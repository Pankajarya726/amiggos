...
class ABookingDetailPresenterImplementation(private var mainView: ABookingDetailsPresenter.ABookingDetailsPresenterMainView, context: Context): ABookingDetailsPresenter.ABookingDetailsPresenterMain {
