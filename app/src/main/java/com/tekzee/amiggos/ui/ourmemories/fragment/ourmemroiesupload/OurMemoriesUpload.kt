...
//        input.addProperty("our_story_id", InviteFriendAfterCreateMemory.ourMemoryId)
...
//                if (InviteFriendAfterCreateMemory.selectUserIds.contains(userid)) {
...
//
//            if(!InviteFriendAfterCreateMemory.selectUserIds.contains(mydataList[position].userid)){
//                InviteFriendAfterCreateMemory.selectUserIds.add(mydataList[position].userid)
//            }
//
//        }else{
//            if(InviteFriendAfterCreateMemory.selectUserIds.contains(mydataList[position].userid)){
//                InviteFriendAfterCreateMemory.selectUserIds.remove(mydataList[position].userid)
//            }
//        }
//
//
