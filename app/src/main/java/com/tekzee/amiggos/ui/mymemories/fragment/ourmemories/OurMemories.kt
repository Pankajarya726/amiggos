...
//        ourMemoriesPresenterImplementation = OurMemoriesPresenterImplementation(this,requireActivity())
//        setupViewData()
...
//        val onlineFriendRecyclerview: RecyclerView = requireActivity().findViewById(R.id.real_friend_fragment)
