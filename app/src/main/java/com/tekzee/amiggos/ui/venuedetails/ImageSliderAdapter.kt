...
class ImageSliderAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup?): SliderViewHolder {
        ...
        val inflate = LayoutInflater.from(parent!!.getContext()).inflate(R.layout.image_slider_zoom_layout_item, null);
    ...
    override fun onBindViewHolder(viewHolder: SliderViewHolder?, position: Int) {
        ...
        viewHolder.image.setOnTouchListener(ImageMatrixTouchHandler(context))
