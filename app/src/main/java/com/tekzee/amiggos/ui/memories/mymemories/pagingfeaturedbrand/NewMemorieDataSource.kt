...
class NewMemorieDataSource(private val scope:CoroutineScope, private val repository: MemorieFeaturedBrandRepository, private val prefs: SharedPreference) :
    ...
    override fun loadInitial(
        ...
        scope.launch {
            try {
                ...
                jsoninput.addProperty("name","")

                val response  = repository.doGetMemorie(jsoninput, Utility.createHeaders(prefs))
                if(response.status){
