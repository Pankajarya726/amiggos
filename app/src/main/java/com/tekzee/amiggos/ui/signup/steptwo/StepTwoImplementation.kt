...
class StepTwoImplementation(private var mainView: StepTwoPresenter.StepTwoPresenterMainView, context: Context): StepTwoPresenter.StepTwoPresenterMain {
    ...
    override fun doUpdateUserInformation(input: JsonObject, createHeaders: HashMap<String, String?>) {
        mainView.showProgressbar()
        if (mainView.checkInternet()) {
            disposable = ApiClient.instance.doUpdateUserInformation(input,createHeaders)
