...
class APartyInvitesNotificationAdapter(
    val mContext: Context, mRecyclerView: RecyclerView, val mLayoutManager: LinearLayoutManager,
    mRecyclerViewAdapterCallback: InfiniteScrollRecyclerView.RecyclerViewAdapterCallback, var mDataList: ArrayList<PartyInvitesNotificationResponse.Data.UserNotification>, val mItemClickCallback: HomeItemClick?)
    : RecyclerView.Adapter<APartyInvitesNotificationAdapter.ViewHolder>(){
