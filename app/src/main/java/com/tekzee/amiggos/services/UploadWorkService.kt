...
class UploadWorkService(context: Context, workerParams: WorkerParameters) : Worker(
    context,
    workerParams
), KodeinAware {

    private val TAG = UploadWorkService::class.java.simpleName
