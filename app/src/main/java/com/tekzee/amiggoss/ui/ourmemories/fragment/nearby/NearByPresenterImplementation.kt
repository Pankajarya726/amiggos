...
class NearByPresenterImplementation(
    private var mainView: NearByPresenter.NearByMainView,
    context: Context
) : NearByPresenter.NearByMainPresenter {
    ...
    override fun doCallNearBy(
        ...
        if (mainView.checkInternet()) {
            disposable = ApiClient.instance.doCallNearBy(input,createHeaders)
