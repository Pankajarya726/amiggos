...
import com.tekzee.amiggoss.databinding.LoginNewBinding
...
import com.tekzee.amiggoss.ui.signup.stepone.StepOne
...
import com.tekzee.amiggoss.ui.forgetpassword.AForgetPassword
...
class ALogin: BaseActivity(), ALoginPresenter.ALoginPresenterMainView {
    ...
    private fun checkIfFirebaseUserExist(responseData: ALoginResponse.Data) {
        ...
        auth.signInWithEmailAndPassword(responseData.email, "amiggoss@123")
            .addOnCompleteListener(this) { task: Task<AuthResult> ->
                ...
                if(task.isSuccessful){
                    ...
                    if (firebaseUser != null) {
                        ...
                        auth.createUserWithEmailAndPassword(responseData.email, "amiggoss@123")
