...
import com.tekzee.amiggoss.ui.home.model.VenueResponse
...
//            mainView.hideProgressbar()
    ...
    override fun getNearByUserCount(
        input: JsonObject,
        createHeaders: HashMap<String, String?>
    ) {
...
//        mainView.showProgressbar()
        if (mainView.checkInternet()) {
            disposable = ApiClient.instance.getNearByUserCount(input,createHeaders)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe({ response ->
                    mainView.hideProgressbar()
