package com.tekzee.amiggoss.ui.ourmemories
...
import com.tekzee.amiggoss.databinding.ActivityOurMemoriesBinding
import com.tekzee.amiggoss.ui.homescreen_new.AHomeScreen
import com.tekzee.amiggoss.ui.ourmemories.fragment.nearby.NearBy
import com.tekzee.amiggoss.ui.ourmemories.fragment.ourmemroiesupload.OurMemoriesUpload
import com.tekzee.amiggoss.ui.ourmemories.service.FileOurMemoryUploadService
import com.tekzee.amiggoss.ui.postmemories.service.FileUploadService
...
class OurMemoriesActivity : BaseActivity() {
    ...
    private fun callUploadImageToMyMemories(commaSeperatedString: String) {
        if (intent.getStringExtra(ConstantLib.FROM).equals("VIDEO", true)) {
            ...
            val imageUri: Uri = intent.getStringExtra(ConstantLib.FILEURI)!! as Uri
            val mIntent = Intent(this, FileUploadService::class.java)
            mIntent.putExtra(ConstantLib.USER_ID, sharedPreference!!.getValueInt(ConstantLib.USER_ID).toString())
            mIntent.putExtra(ConstantLib.FILEURI, imageUri)
